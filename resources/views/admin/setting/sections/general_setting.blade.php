        ...
        <div class="card-body border">
            <form action="{{ route('admin.general-setting.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="footer_info" type="text" class="form-control" value="{{config('settings.footer_info')}}">
                </div>
                <div class="form-group">
                    <label for="">Footer address</label>
                    <input name="footer_address" type="text" class="form-control" value="{{config('settings.footer_address')}}">
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Footer Email</label>
                            <input name="footer_email" type="text" class="form-control" value="{{config('settings.footer_email')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Footer Phone</label>
                            <input name="footer_phone" type="text" class="form-control" value="{{config('settings.footer_phone')}}">
                        </div>
                    </div>
                </div>
