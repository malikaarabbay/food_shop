                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-10">
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        @include('admin.setting.sections.general_setting')

                                        @include('admin.setting.sections.logo_setting')

                                        @include('admin.setting.sections.appearance_setting')

                                        @include('admin.setting.sections.pusher_setting')

                                        @include('admin.setting.sections.mail_setting')

                                        @include('admin.setting.sections.seo_setting')
