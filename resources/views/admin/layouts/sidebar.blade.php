...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a target="_blank" href="{{ url('/') }}">{{config('settings.site_name')}}</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ setSidebarActive(['admin.dashboard']) }}"><a class="nav-link" href="{{ route('admin.dashboard') }}">
                    <i class="fas fa-fire"></i>Dashboard</a></li>
            ...
            <li class="dropdown {{ setSidebarActive([
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.delivery.*']) }}" ><a class="nav-link" href="{{ route('admin.delivery.index') }}">Delivery Areas</a></li>
            ...
            <li class="dropdown {{ setSidebarActive([
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.blog.*']) }}" ><a class="nav-link" href="{{ route('admin.blog.index') }}">All Blogs</a></li>
                    <li class="{{ setSidebarActive(['admin.blog.comments.index']) }}" ><a class="nav-link" href="{{ route('admin.blog.comments.index') }}">Comments</a></li>
                    </li>
                </ul>
            </li>
            ...
            'admin.counter.index'
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.banner.*']) }}"><a class="nav-link" href="{{ route('admin.banner.index') }}">Banner</a></li>
                    <li class="{{ setSidebarActive(['admin.chefs.*']) }}"><a class="nav-link" href="{{ route('admin.chefs.index') }}">Chefs</a></li>
                    <li class="{{ setSidebarActive(['admin.app-download.index']) }}"><a class="nav-link" href="{{ route('admin.app-download.index') }}">App Download</a>
                    </li>
                    <li class="{{ setSidebarActive(['admin.feedbacks.*']) }}"><a class="nav-link" href="{{ route('admin.feedbacks.index') }}">Feedbacks</a></li>
            ...
            <li class="{{ setSidebarActive(['admin.subscribe.index']) }}"><a class="nav-link" href="{{ route('admin.subscribe.index') }}"><i class="fas fa-newspaper"></i>
            ...
            <li class="{{ setSidebarActive(['admin.menu.index']) }}"><a class="nav-link" href="{{ route('admin.menu.index') }}"><i class="fas fa-list-alt"></i>
