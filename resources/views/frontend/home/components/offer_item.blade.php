            ...
            @foreach($dailyOffers as $dailyOffer)
                <div class="col-xl-4">
                    <div class="fp__offer_item_single">
                        <div class="img">
                            <img src="{{ asset($dailyOffer->product->image) }}" alt="offer" class="img-fluid w-100">
                        </div>
                        <div class="text">
                            ...
                            @endif
                            <a class="title" href="{{ route('product.show', $dailyOffer->product->slug) }}">{!! $dailyOffer->product->title !!}</a>
