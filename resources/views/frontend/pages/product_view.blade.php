            ...
            <div class="container">
                <div class="fp__breadcrumb_text">
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:void(0);">menu Details</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    @foreach($relatedProducts as $relatedProduct)
                        ...
                        <div class="fp__menu_item">
                            <div class="fp__menu_item_img">
                                <img src="{{ asset($relatedProduct->image) }}" alt="menu" class="img-fluid w-100">
                                <a class="category" href="#">{{ @$relatedProduct->category->title }}</a>
                            </div>
                            <div class="fp__menu_item_text">
                                ...
                                <a class="title" href="{{ route('product.show', $relatedProduct->slug) }}">{{ $relatedProduct->title }}</a>
                                <h5 class="price">
