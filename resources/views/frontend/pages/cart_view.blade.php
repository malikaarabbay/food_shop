                                ...
                                @foreach (Cart::content() as $cart)
                                    <tr>
                                        <td class="fp__pro_img"><img
                                                src="{{ $cart->options->product_info['image'] }}" alt="product"
                                                class="img-fluid w-100">
                                        </td>

                                        <td class="fp__pro_name">
                                            <a
                                                href="{{ route('product.show', $cart->options->product_info['slug']) }}">{{ $cart->name }}</a>
                                        ...
                                        <td class="fp__pro_status">
                                            <h6>{{ currencyPosition($cart->price) }}</h6>
                                        </td>
                                        ...
                                        <td class="fp__pro_select">
                                            <div class="quentity_btn">
                                                ...
                                                <input type="text" class="quantity" data-id="{{ $cart->rowId }}"
                                                       placeholder="1" value="{{ $cart->qty }}" readonly>
                                        ...
                                        <td class="fp__pro_tk">
                                            <h6 class="produt_cart_total">
                                                {{ currencyPosition(productTotal($cart->rowId)) }}</h6>
                                        </td>

                                        <td class="fp__pro_icon">
                                            <a href="#" class="reomove_cart_product"
                                               data-id="{{ $cart->rowId }}"><i class="far fa-times"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
