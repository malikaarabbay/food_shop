...
/** Product modal route */
Route::get('/load-product-modal/{product}', [FrontendController::class, 'loadProductModal'])->name('load-product-modal');
...
/** Feedback page */
Route::get('/feedbacks', [FrontendController::class, 'feedback'])->name('feedback');
